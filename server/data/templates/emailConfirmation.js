...
const emailConfirmTemplate = verificationToken => {
  ...
  <body style="background-color: #f3f8fa; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF;">
      <tbody>
        <tr>
          <td>
            <table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f3f8fa; background-image: url('https://d1oco4z2z1fhwp.cloudfront.net/templates/default/6451/bg_hero_nut.png'); background-position: center top; background-repeat: no-repeat;">
              <tbody>
                <tr>
                  <td>
                        ...
                        <tr>
                          <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                            ...
                            <table class="heading_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                              <tr>
                                <td class="pad" style="padding-bottom:10px;text-align:center;width:100%;">
                                  <h2 style="margin: 0; color: #528252; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Інтернет-магазин електронної техніки</span></h2>
                                </td>
                              </tr>
                            </table>
                            ...
                            <table class="heading_block block-6" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                              <tr>
                                <td class="pad" style="text-align:center;width:100%;">
                                  <h3 style="margin: 0; color: #8a3c90; direction: ltr; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 24px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">кращі пропозиції вчасно</span></h3>
                                </td>
                              </tr>
                            </table>
                            ...
                            <table class="heading_block block-8" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                              <tr>
                                <td class="pad" style="text-align:center;width:100%;">
                                  <h2 style="margin: 0; color: #1e251c; direction: ltr; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 44px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                  Вашу email адресу було використано під час реєстрації на нашому сайті. Якщо це були ви, перейдіть за посиланням нижче для підтвердження.
                                </h2>
                                </td>
                              </tr>
                            </table>
                              ...
                              <tr>
                                <td class="pad">
                                  <div style="color:#101112;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                    <p style="margin: 0; margin-bottom: 16px;">Якщо ви не реєструвались на нашому сайті, у вас є чудова можливість </p>
                                    <p style="margin: 0;"><span style="color: #41950d;"><strong><a href="${BASE_FRONTEND_URL}" target="_blank" style="text-decoration: underline; color: #8a3c90;" rel="noopener">by <span style="font-family: inherit; background-color: transparent;">Якщо ви перейдете за ЦИМ посиланням</span></a></strong></span></p>
                                  </div>
                                </td>
                              </tr>
                            </table>
                            ...
                            <table class="image_block block-15" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                              <tr>
            
                              </tr>
                            </table>
                            <div class="spacer_block block-16" style="height:60px;line-height:60px;font-size:1px;">&#8202;</div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
